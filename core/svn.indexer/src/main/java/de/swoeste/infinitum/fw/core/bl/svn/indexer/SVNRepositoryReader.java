...
public class SVNRepositoryReader implements ISVNContentReader {
    ...
    /**
     * Sometimes the type of a node could not be get directly from the
     * SVNLogEntryPath object. Then we need to connect with the svn repository
     * and ask for the correct type of the node. This method check if the type
