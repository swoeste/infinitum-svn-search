...
public class SVNEntryTest {
    ...
    public void testSVNIndexItemData(final String path, final SVNNodeKind svnNodeKind, final String expectedName, final String expectedType, final boolean isFile)
            throws Exception {
