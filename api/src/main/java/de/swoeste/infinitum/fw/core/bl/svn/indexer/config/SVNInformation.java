...
public class SVNInformation {
    ...
    public String toString() {
        return MessageFormat.format("SVNInformation [repositoryUrl={0}, username={1}, password={2}, authentication={3}]",  //$NON-NLS-1$
                this.repositoryUrl, this.username, this.password, this.authentication);
    }
