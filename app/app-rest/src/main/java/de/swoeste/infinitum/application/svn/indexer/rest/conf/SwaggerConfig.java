...
public class SwaggerConfig {
    ...
    private static final String API_PATH_PATTERN = "/rest/api/*"; //$NON-NLS-1$
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).select()//
                ...
                .paths(PathSelectors.ant(API_PATH_PATTERN))//
                .build()//
                .apiInfo(apiInfo());
    }

    private ApiInfo apiInfo() {
        return new ApiInfo("Infinitum SVN Search REST API", "The REST API to access Infinitum SVN Search.", "1.0.0", "",
                new Contact("Sebastian Woeste", "swoeste.de", "dev@swoeste.de"), "The Apache Software License, Version 2.0", "http://www.apache.org/licenses/LICENSE-2.0.txt",
